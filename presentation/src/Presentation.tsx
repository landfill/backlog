...
const transitions: any[] = [
  fade(),       // 01→02
  slide({ direction: "from-right" }),  // 02→03
  fade(),       // 03→04 (섹션 전환)
  wipe({ direction: "from-left" }),    // 04→05
  slide({ direction: "from-right" }), // 05→06
  wipe({ direction: "from-left" }),   // 06→07
  fade(),       // 07→08 (섹션 전환)
  slide({ direction: "from-right" }), // 08→09
  wipe({ direction: "from-left" }),   // 09→10
  fade(),       // 10→11 (섹션 전환)
  slide({ direction: "from-right" }), // 11→12
  fade(),       // 12→13 (섹션 전환)
  slide({ direction: "from-right" }), // 13→14
  fade(),       // 14→15 (클로징)
];
